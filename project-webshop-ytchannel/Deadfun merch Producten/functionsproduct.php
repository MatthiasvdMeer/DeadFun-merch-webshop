...
include_once "configproduct.php";
 ...
 function crudMain(){
    ...
    <h1>Crud</h1>
    <nav>
		<a href='insertproduct.php'>Toevoegen nieuwe Item</a>
    </nav><br>";
    echo $txt;
...
function printCrudTabel($result) {
    ...
    foreach ($result as $row) {
        ...
        foreach ($row as $key => $cell) {
            if ($key === 'Foto') {
                // Display image if the column is 'Foto'
                $table .= "<td><img src='data:image/jpeg;base64," . base64_encode($cell) . "' alt='Product Image' style='width:100px;height:auto;'></td>";
            } else {
        ...
        // Verwijder knopje
        $table .= "<td>
            <form method='post' action='deleteproduct.php?id=$id'>       
